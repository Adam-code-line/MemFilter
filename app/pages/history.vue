  ...
  <div class="max-w-6xl mx-auto space-y-12 pb-20">
      ...
      <UCard class="border border-gray-200/70 dark:border-white/10">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div class="space-y-2">
            ...
            <p v-if="heroSection?.helper" class="text-sm text-gray-500 dark:text-gray-400">
              {{ heroSection.helper }}
            </p>
          </div>
          <UButton
    ...
    <section class="space-y-6">
      <div class="space-y-2">
        ...
        <p v-if="overviewDescription" class="text-sm text-gray-500 dark:text-gray-400">
          {{ overviewDescription }}
        </p>
      </div>
