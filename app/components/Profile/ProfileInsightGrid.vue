      ...
      >
        <div class="flex items-start gap-3">
          ...
          <div class="space-y-2">
            ...
            <p v-if="insight.description" class="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
              {{ insight.description }}
            </p>
            <div v-if="insight.metric" class="inline-flex items-center gap-2 rounded-lg bg-primary-50/80 px-3 py-1 text-sm font-medium text-primary-600 dark:bg-primary-500/10 dark:text-primary-200">
