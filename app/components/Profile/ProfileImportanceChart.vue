...
const segments = computed(() => {
  const entries = [
    { key: 'high', label: '核心记忆', color: 'bg-error-500', badge: '高', value: props.distribution.high },
    { key: 'medium', label: '重要记忆', color: 'bg-primary-500', badge: '中', value: props.distribution.medium },
    { key: 'low', label: '次要记忆', color: 'bg-secondary-500', badge: '低', value: props.distribution.low },
    { key: 'noise', label: '噪声内容', color: 'bg-neutral-400', badge: '噪', value: props.distribution.noise }
  ]
      ...
      <div class="space-y-3">
        ...
        >
          ...
          <div class="flex items-center gap-2">
            <span class="tabular-nums text-sm text-gray-800 dark:text-gray-200">{{ segment.value }}</span>
