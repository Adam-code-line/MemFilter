  ...
  >
    ...
    >
      ...
      <div v-if="forgettingProgress > 0" class="forgetting-progress">
        <div class="forgetting-bar" :style="{ width: `${forgettingProgress}%` }"></div>
      </div>
          ...
          <div class="flex items-center space-x-2">
            ...
            <div v-if="fadeLevel > 0" class="forgetting-indicator">
              <UTooltip :text="forgettingTooltip">
                <UIcon :name="forgettingIcon" class="text-amber-500 animate-pulse" size="sm" />
              </UTooltip>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div v-else class="collapsed-hint text-xs text-gray-400 italic">内容已折叠...</div>
      ...
      <template #footer>
        <div class="memory-footer flex justify-between items-center">
          <div class="flex space-x-2">
            <UButton size="sm" variant="ghost" icon="i-lucide-eye" @click="handleOpen">
              查看详情
            </UButton>
