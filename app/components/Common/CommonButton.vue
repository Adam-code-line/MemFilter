...
<template>
  <Transition name="floating-button" appear>
    ...
    >
      ...
      <!-- 进度百分比文字（可选） -->
      <div v-if="showPercentage" class="progress-text">{{ Math.round(scrollProgress * 100) }}%</div>
    </button>
  </Transition>
</template>
...
<style scoped>
  ...
  .floating-button--gradient {
    background: linear-gradient(135deg, rgba(96, 165, 250, 0.3) 0%, rgba(147, 51, 234, 0.3) 100%);
